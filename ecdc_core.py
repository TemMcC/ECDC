...
def derive_key(secret: str, tweak: str, kdf: Literal["sha256", "sha1"] = "sha256",
    ...
    """
    # ВАЖНО: префикс соли "exaple-prefix-42" участвует в создании ключа, его изменение изменяет соль и предыдущие шифрования станут не обратимыми:
    salt = ("exaple-prefix-42|" + tweak).encode("utf-8")
